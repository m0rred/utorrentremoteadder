...
class UTorrentClient(object):
    ...
    def setprops(self, hash, property, value):
        params = [('action', 'setprops'), ('hash', hash), ('s', str(property)), ('v', str(value))]                  
        return self._action(params)
    ...
    def addfile(self, filename, filepath=None, bytes=None):
        ...
        form.add_file('torrent_file', filename, file_handler)#.encode('utf-8')
